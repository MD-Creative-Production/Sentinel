    ...
    <div className="max-w-6xl">
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-gray-500 dark:text-gray-400">Monitor contracts and addresses across networks</p>
        </div>
        <button
      ...
      <WatchlistTable entries={entries} loading={loading} onToggle={handleToggle} onRemove={handleRemove} />

      {showForm && (
        <WatchlistForm onSubmit={addEntry} onClose={() => setShowForm(false)} />
      )}
    </div>
  );
}
